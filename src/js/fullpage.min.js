...
!function (e, t, n, o, r) {
  ...
  return zt.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function (e, t) {
    ...
    if (!Ln(u, Ft)) {
      ...
      Ct(), zt.fp_easings = En(zt.fp_easings, {
        ...
        Z(!1, "internal"), re(!0), ie(!1), le(!1), Nn(d, Yt), [b, w, l, O, M, C, S, P].forEach(function (e) {
          ...
          "-ms-touch-action": "",
          "touch-action": ""
        }), Tn(h, {overflow: "", height: ""}), zn(u, Ft), zn(L, Vt), L.className.split(/\s+/).forEach(function (e) {
    ...
    function Se(e) {
      var t = e.type, o = !1, r = E.scrollOverflow, i = "mouseleave" === t ? e.toElement || e.relatedTarget : e.target;
    ...
    function Le() {
      ...
      if (!T && (!E.autoScrolling || E.scrollBar)) {
        ...
        if (t = a, n = yn(Qt)[0].offsetTop, o = n + xn(), ("up" != t ? n <= Un() : o >= Un() + xn()) && (Ln(yn(Qt)[0], _t) || (Nn(yn(Qt)[0], _t), zn(Xn(yn(Qt)[0]), _t))), !Ln(e = f[s], Xt)) {
          F = !0;
          var v, p, h = yn(Qt)[0], g = In(h, qt) + 1, m = vt(e), S = e.getAttribute("data-anchor"), w = In(e, qt) + 1,
            b = yn(an, e)[0],
